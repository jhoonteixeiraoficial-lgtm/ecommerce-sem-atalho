  ...
  return (
    <div className="space-y-6">
      ...
      <div className="grid sm:grid-cols-2 gap-3">
        {[
          { icon: MessageCircle, title: 'Chat ao Vivo', desc: 'Fale com nossa equipe.', schedule: 'Seg-Sex: 9h às 18h', cta: 'Iniciar Chat', color: 'text-accent', href: '#', onClick: () => alert('Chat ao vivo indisponível no momento. Tente novamente durante o horário comercial.') },
          { icon: Mail, title: 'E-mail', desc: 'Envie sua dúvida por e-mail.', schedule: 'suporte@ecommercesematalho.com.br', cta: 'Enviar E-mail', color: 'text-blue-400', href: 'mailto:suporte@ecommercesematalho.com.br' },
          { icon: Book, title: 'Base de Conhecimento', desc: 'Artigos e tutoriais.', schedule: '', cta: 'Acessar', color: 'text-green-400', href: '#', onClick: () => alert('Base de conhecimento em construção.') },
          { icon: Video, title: 'Videoaulas de Ajuda', desc: 'Aprenda a usar a plataforma.', schedule: '', cta: 'Acessar', color: 'text-purple-400', href: '/membros/aulas' },
        ].map((item, i) => (
          <div key={i} className="p-5 rounded-xl bg-surface border border-border-subtle">
            <div className="flex items-start gap-3">
              ...
              <div>
                ...
                {item.onClick ? (
                  <Button size="sm" variant="secondary" className="mt-3" onClick={item.onClick}>
